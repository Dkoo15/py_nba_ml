...
for year in seasons:
    url_to_json(urls,
                ['leaguedashplayerstats', 'Base', 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashplayerstats', 'Advanced', 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashplayerstats', 'Misc', 'PerGame', year, ''])
...
urls = ['http://stats.nba.com/stats/',
        ('?College=&Conference=&Country=&DateFrom=&DateTo=&Division=&DraftPick'
         '=&DraftYear=&GameScope=&GameSegment=&Height=&LastNGames=0&LeagueID='
         '00&Location=&Month=0&OpponentTeamID=0&Outcome=&PORound=0&PerMode='),
...
for year in seasons:
    url_to_json(urls,
                ['leaguedashptstats', 'PerGame', 'Team',
                 'Efficiency', year, ''])
    url_to_json(urls,
                ['leaguedashptstats', 'PerGame', 'Team',
                 'Passing', year, ''])
...
urls = ['http://stats.nba.com/stats/',
        ('?College=&Conference=&Country=&DateFrom=&DateTo=&DistanceRange='
         'By+Zone&Division=&DraftPick=&DraftYear=&GameScope=&GameSegment=&'
         'Height=&LastNGames=0&LeagueID=00&Location=&MeasureType='),
        '&Month=0&OpponentTeamID=0&Outcome=&PORound=0&PaceAdjust=N&PerMode=',
...
for year in seasons:
    url_to_json(urls,
                ['leaguedashplayershotlocations', 'Base', 'PerGame', year, ''])
...
for year in seasons:
    url_to_json(urls,
                ['leaguedashptdefend', 'Less+Than+6Ft',
                 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashptdefend', 'Less+Than+10Ft',
                 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashptdefend', 'Greater+Than+15Ft',
                 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashptdefend', '2+Pointers',
                 'PerGame', year, ''])
    url_to_json(urls,
                ['leaguedashptdefend', '3+Pointers',
                 'PerGame', year, ''])
